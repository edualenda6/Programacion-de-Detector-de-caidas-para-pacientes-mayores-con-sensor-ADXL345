...
const char* ssid = "vodafoneBA1022_EXT";
const char* password = "7CEPE96EMRM5DLUP";
const char* botToken = "7591963627:AAGNbcN8nOUbb4fxfcb25-GfTpEK8Jipvuo";
const char* chatId = "1168441956";
